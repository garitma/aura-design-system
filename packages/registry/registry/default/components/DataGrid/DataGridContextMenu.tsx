    ...
    >
      ...
      >
        <DropdownMenuItem onSelect={onCopy} className="gap-1">
          <ClipboardCopyIcon className="icon shrink-0 text-gray-11" aria-hidden />
          Copy
        </DropdownMenuItem>
        <DropdownMenuItem
          onSelect={onCut}
          ...
          className="gap-1"
        >
          <ScissorsIcon className="icon shrink-0 text-gray-11" aria-hidden />
          Cut
        </DropdownMenuItem>
        <DropdownMenuItem
          onSelect={onClear}
          ...
          className="gap-1"
        >
          <EraserIcon className="icon shrink-0 text-gray-11" aria-hidden />
          Clear
        </DropdownMenuItem>
        {onRowsDelete && (
          <>
