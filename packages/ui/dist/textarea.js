...
const Textarea = ({ isDisabled, isHelping, isLabelable, helpMode = "warning", helpText, placeholder, className, classNameContainer, name, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: classContainerConnect.join(" ").trim(), children: (0, jsx_runtime_1.jsxs)("div", { className: `inputer-group`, children: [(0, jsx_runtime_1.jsxs)("div", { className: "halo", children: [(0, jsx_runtime_1.jsx)("textarea", { name: name, "aria-label": placeholder, placeholder: placeholder, disabled: isDisabled, className: classConnect.join(" ").trim(), value: validateValue(value), ...inputProps }), placeholder && isLabelable && ((0, jsx_runtime_1.jsx)("label", { htmlFor: name, children: placeholder }))] }), isHelping && (0, jsx_runtime_1.jsx)("div", { className: `${helpMode}-text aura`, children: helpText })] }) }));
};
