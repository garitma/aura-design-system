...
- **Authoring** — MDX and `meta.json` under `apps/www/content/docs/` (Get Started includes Installation, [[CLI]], MCP + Agent blueprint; also handbook, components, forms, rules, etc.).
