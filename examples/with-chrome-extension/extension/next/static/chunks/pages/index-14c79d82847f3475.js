  ...
  [405],
  {
    4129: function (e, t, n) {
      ...
      t.default = function (e) {
        var t = e.sprite,
          n = e.className,
          a = i(e, ["sprite", "className"]);
        return (0, s.jsx)(
          "i",
          r({ className: ["icon", t, n].join(" ").trim() }, a),
          void 0
        );
      };
    },
    7282: function (e, t, n) {
      ...
      t.default = function (e) {
        var t = e.children,
          ...
          a = e.col,
          o = e.isFixed,
          l = i(e, ["children", "className", "col", "isFixed"]),
          c = ["aureole", n];
        return (
          a && c.push(a),
          o && c.push("fixed"),
          (0, s.jsx)(
            "div",
            r({ className: c.join(" ") }, l, { children: t }),
            void 0
          )
        );
      };
    ...
    9749: function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = function (e) {
          ...
          let T = o.useContext(d.ImageConfigContext),
            B = o.useMemo(() => {
            ...
            L = M,
            W = L.loader || m.default;
          if ((delete L.loader, "__next_img_default" in W)) {
            if ("custom" === B.loader)
              throw Error(
                'Image with src "'.concat(s, '" is missing "loader" prop.') +
          ...
          if (z) {
            ...
            q && (_ = r({}, _, q));
            let F = { responsive: "100vw", fill: "100vw" }[z];
            F && !g && (g = F);
          }
          let G = "",
            Z = p(S),
            V = p(N);
          if ("object" == typeof (i = s) && (h(i) || void 0 !== i.src)) {
            let H = h(s) ? s.default : s;
            if (!H.src)
              throw Error(
            ...
            if (
              ...
              if (Z || V) {
                if (Z && !V) {
                  let J = Z / H.width;
                  V = Math.round(H.height * J);
                } else if (!Z && V) {
                  let X = V / H.height;
                  Z = Math.round(H.width * X);
                }
              } else (Z = H.width), (V = H.height);
            }
          }
          let $ = !b && ("lazy" === x || void 0 === x);
          ((s = "string" == typeof s ? s : G).startsWith("data:") ||
            s.startsWith("blob:")) &&
            ((y = !0), ($ = !1)),
            B.unoptimized && (y = !0);
          let [K, Q] = o.useState(!1),
            [Y, ee] = o.useState(!1),
            et = p(w),
            en = Object.assign(
              O
            ...
            ei = (function (e) {
              ...
              let { widths: l, kind: c } = (function (e, t, n) {
                  ...
                  if (n) {
                    let s = /(^|\s)(1?\d?\d)vw/g,
                      a = [];
                    for (let o; (o = s.exec(n)); o) a.push(parseInt(o[2]));
                    if (a.length) {
                      let l = 0.01 * Math.min(...a);
                      return {
                        widths: i.filter((e) => e >= r[0] * l),
                        kind: "w",
                      };
                    }
              ...
              return {
                ...
                srcSet: l
                  ...
                  .join(", "),
                src: o({ config: t, src: n, quality: s, width: l[u] }),
              };
            })({
              config: B,
              src: s,
          ...
          return o.default.createElement(
            o.default.Fragment,
            null,
            o.default.createElement(v, Object.assign({}, ec)),
            b
      ...
      function g(e, t, n, i, s, a, o) {
        if (!e || e["data-loaded-src"] === t) return;
        e["data-loaded-src"] = t;
        let l = "decode" in e ? e.decode() : Promise.resolve();
        l.catch(() => {}).then(() => {
          if (e.parentNode) {
            if (("blur" === n && a(!0), null == i ? void 0 : i.current)) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.getImageBlurSvg = function (e) {
          let {
            ...
            a = r || t,
            o = i || n,
            l = s.startsWith("data:image/jpeg")
    ...
    9561: function (e, t, n) {
                  ...
                  children: [
                    ...
                    (0, r.jsx)("li", {
                      ...
                      children: (0, r.jsx)(b(), {
                        ...
                        target: "_blank",
                        rel: "noopener",
                        children: (0, r.jsx)(v(), { sprite: "github" }),
                      }),
                    }),
                  ],
                }),
              ...
              (0, r.jsx)("div", {
                children: (0, r.jsx)("div", {
                  children:
                    t &&
                    (0, r.jsx)("h1", {
                      className: "light centertxt mt0 mb0",
                      children: t,
                    }),
                }),
              }),
      ...
      var w = n(9008),
        S = n.n(w);
      let N = "Aura Design Next Base",
        O = (e) => {
          let { title: t, excerpt: n, slug: i, image: s } = e;
          return (0, r.jsxs)(S(), {
            children: [
              ...
              (0, r.jsx)("title", {
                children: t ? "".concat(t, " | ").concat(N) : N,
              }),
              (0, r.jsx)("meta", {
                property: "og:title",
                content: t ? "".concat(t, " | ").concat(N) : N,
              }),
              (0, r.jsx)("link", {
                rel: "canonical",
                href: "".concat("http://localhost:3000/").concat(i || ""),
              }),
              (0, r.jsx)("meta", {
                property: "og:image:alt",
                content: n || "Open grap de ".concat(N),
              }),
              (0, r.jsx)("meta", {
      ...
      c().events.on("routeChangeStart", () => {
        ...
        c().events.on("routeChangeError", () => {
          d().done();
        });
      let _ = (e) => {
          let { children: t, text: n, seo: i } = e;
          return (0, r.jsx)("main", {
            children: (0, r.jsxs)("div", {
              ...
              children: [
                (0, r.jsx)(O, { ...i }),
                (0, r.jsx)(x, { text: n }),
                (0, r.jsx)("div", { className: "page-body", children: t }),
                (0, r.jsx)(j, {}),
              ],
            }),
          });
        ...
        E = () =>
          (0, r.jsxs)(_, {
            text: "Aura Design Next Base",
            children: [
              (0, r.jsxs)(s(), {
                color: "yellow",
                className: "centertxt",
                children: [
                  (0, r.jsx)("h2", { children: "Welcome to my imagination" }),
                  (0, r.jsxs)("p", {
                    children: [
                      "Get started by editing",
                      " ",
                      (0, r.jsx)("span", {
                        className: "wall-pad info info-text",
                        children: "public/style.css",
                      }),
                    ],
                  }),
                ],
                  ...
                  children: [
                    (0, r.jsx)("a", {
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [
                          (0, r.jsxs)("h3", {
                            className: "mod-title mb0",
                            children: [
                              "Documentation ",
                              (0, r.jsx)("i", {
                                className: "icon arrowAltRigth",
                              }),
                            ],
                          }),
                          (0, r.jsx)("p", {
                    ...
                    (0, r.jsx)("a", {
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, r.jsx)("p", {
                            children:
                              "Discover and deploy boilerplate example Aura Design System projects.",
                          }),
                        ],
                      }),
                    }),
                    (0, r.jsx)("a", {
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, r.jsx)("p", {
                            children:
                              "Aura Design System is built under its own rules, it is very structured and not very flexible, designed to solve my problems. If my problems are yours too, welcome.",
                          }),
                        ],
                      }),
                    }),
            ...
            (r.configure = function (e) {
              ...
              (r.render = function (e) {
                ...
                return (
                  ...
                  !i.showSpinner &&
                    (s = t.querySelector(i.spinnerSelector)) &&
                    m(s),
