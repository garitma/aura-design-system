...
function LinksExample({ muted = false }: { muted?: boolean }) {
  return (
    <blockquote
      className={cn(
        "border-l-2 border-accent-9 pl-1.5",
...
function ComponentsShowcase() {
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-[minmax(0,320px)_minmax(0,1fr)_minmax(0,320px)]">
      {/* Left column */}
      <div className="mx-auto flex w-full max-w-[400px] flex-col gap-2.5">
        <div className="flex gap-1">
        ...
        <div className="flex flex-wrap items-center justify-center gap-1 sm:justify-between">
          ...
          <Button type="button" size="icon" variant="fill" aria-label="Bookmark">
            <BookmarkIcon className="icon" />
          </Button>
          <Button type="button" size="icon" variant="pill" aria-label="Accessibility">
          ...
          {[false, true].map((surface) => (
            ...
            >
              ...
              <div className="min-w-0">
                <p className="truncate font-medium text-gray-12">Emily Adams</p>
      ...
      {/* Center column */}
      <div className="order-first mx-auto flex w-full max-w-[480px] flex-col gap-2.5 lg:order-none">
        <div className="hidden items-center gap-1 lg:flex">
          <div className="flex items-center gap-0.5 rounded-md border border-gray-a6 px-0.5">
            {(
              [
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button type="button" variant="pill" className="flex-1">
                Actions
              </Button>
            </DropdownMenuTrigger>
        ...
        <div className="relative overflow-hidden rounded-xl border border-gray-6 bg-gray-2 px-2 py-3">
          ...
          <div className="relative mx-auto max-w-[400px]">
            ...
            <Card className="border-gray-6 bg-gray-1/95 backdrop-blur-sm">
              <CardHeader className="pb-1">
                <CardTitle className="h6 text-gray-12">Create account</CardTitle>
              </CardHeader>
...
export default function AuraAesthetic() {
  ...
  return (
    <section className="border-t border-gray-6 bg-gray-1">
      <div className="smash pad flex flex-col gap-3 py-3">
