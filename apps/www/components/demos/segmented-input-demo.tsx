...
export const SegmentedInputDemo = () => {
...
export const SegmentedInputDemoFormInput = () => {
...
export const SegmentedInputDemoRgbColor = () => {
...
export const SegmentedInputDemoVertical = () => {
...
export const SegmentedInputDemoSizes = () => (
...
export const SegmentedInputDemoInvalid = () => (
  <div className="flex w-full max-w-sm flex-col gap-1">
