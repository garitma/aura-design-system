...
export const MarkerDemoVariants = () => (
  <div className="flex w-full max-w-md flex-col gap-1">
    <Marker>
...
export const MarkerDemoSeparator = () => (
  <div className="flex w-full max-w-md flex-col gap-1">
    <Marker variant="separator">
...
export const MarkerDemoWithIcon = () => (
  <div className="flex w-full max-w-md flex-col gap-1">
    <Marker>
      <MarkerIcon>
        <GitHubLogoIcon className="icon" />
