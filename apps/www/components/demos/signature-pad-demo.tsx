...
export const SignaturePadDemo = () => <SignaturePad />;

export const SignaturePadDemoWithoutButtons = () => <SignaturePad showButtons={false} />;

export const SignaturePadDemoVariants = () => (
...
export const SignaturePadDemoWithOnChange = () => {
...
export const SignaturePadDemoWithRefMethods = () => {
...
export const SignaturePadDemoCombinedExample = () => {
