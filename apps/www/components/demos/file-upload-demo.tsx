...
export const FileUploadDemoWithValidation = () => {
  const [files, setFiles] = React.useState<File[]>([]);
...
export const FileUploadDemoDirectUpload = () => {
  const [files, setFiles] = React.useState<File[]>([]);
...
export const FileUploadDemoCircularProgress = () => {
  const [files, setFiles] = React.useState<File[]>([]);
...
export const FileUploadDemoFillProgress = () => {
  const [files, setFiles] = React.useState<File[]>([]);
