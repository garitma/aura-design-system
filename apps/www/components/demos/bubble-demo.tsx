...
export const BubbleDemoVariants = () => (
...
export const BubbleDemoAlignment = () => (
  <div className="flex w-full max-w-md flex-col gap-2">
...
export const BubbleDemoReactions = () => (
