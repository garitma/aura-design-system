...
export const EditableDemoWithTrigger = () => (
...
export const EditableDemoDoubleClick = () => (
  <Editable
...
export const EditableDemoAutosize = () => (
  <Editable
    defaultValue="Aura"
    placeholder="Type…"
    autosize
...
export const EditableDemoTodoList = () => {
...
export const EditableDemoWithForm = () => {
