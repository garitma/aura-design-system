  ...
  return (
    <NavigationMenu value={value} onValueChange={setValue} asChild>
      <header
        ...
        {...props}
        className={cn(
          "fixed top-0 z-40 left-0 right-(--removed-body-scroll-bar-size,0) border-b transition-colors *:mx-auto *:max-w-fd-container bg-gray-2 border-gray-a6 text-gray-12",
