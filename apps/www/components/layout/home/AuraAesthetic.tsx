...
import { generateRadixColors, getColorName } from "@/utils/colors";
...
@layer components {
  ...
  }, [accentColor, grayColor, backgroundColor, radius]);
            ...
            <div className="absolute top-4 right-4 z-10">
              <ThemeColorSwitcher
                ...
                onConfigChange={(newConfig) => {
                  setAccentColor(newConfig.accent);
                  setGrayColor(newConfig.gray);
                  setBackgroundColor(newConfig.background);
                  setMode(newConfig.appearance);
                }}
                className="relative"
