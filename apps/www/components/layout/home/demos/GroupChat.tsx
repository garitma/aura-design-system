...
export function GroupChat() {
    return (
        <Card className="flex flex-col h-full bg-gray-2 text-gray-12 border-gray-6 overflow-hidden">
            {/* Header */}
            <div className="p-1.5 border-b border-gray-6 flex items-center justify-between bg-gray-2/50 backdrop-blur-md z-10">
                <div className="flex items-center gap-1">
                    <div className="flex -space-x-1 overflow-hidden">
                        <Avatar className="border-2 border-gray-2 w-4 h-4">
                    ...
                    <div>
                        <div className="flex items-center gap-0.5">
                            <h3 className="font-semibold text-sm text-gray-12">Music Night Out</h3>
                ...
                <div className="flex gap-0.5">
                    <Button variant="menu" className="h-4 w-4 text-gray-11 hover:text-gray-12 hover:bg-gray-4 p-0">
                ...
                <div className="space-y-1.5">
                    <div className="flex gap-1">
                        ...
                        <div className="bg-gray-3 p-1 rounded-lg rounded-tl-none max-w-[80%]">
                            <p className="text-sm text-gray-12">Are we still on for the jazz club tonight? 🎷</p>
                        </div>
                    </div>

                    <div className="flex gap-1 flex-row-reverse">
                        <div className="bg-accent-9 text-white p-1 rounded-lg rounded-tr-none max-w-[80%]">
                    ...
                    <div className="flex gap-1">
                        ...
                        <div className="bg-gray-3 p-1 rounded-lg rounded-tl-none max-w-[80%]">
                            <p className="text-sm text-gray-12">Who's got that group photo from last time?</p>
                        </div>
                    </div>
                </div>
            </ScrollArea>
            ...
            {/* Input */}
            <div className="p-1 bg-gray-2/50 backdrop-blur-md">
                <div className="relative flex items-center gap-0.5">
                    <Button variant="menu" className="h-4 w-4 rounded-full text-gray-11 hover:text-gray-12 shrink-0 p-0">
                    ...
                    />
                    <Button className="h-4 w-4 rounded-full shrink-0 p-0 flex items-center justify-center">
