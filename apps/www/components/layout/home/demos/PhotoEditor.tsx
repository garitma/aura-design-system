...
const FILTERS = [
  ...
  {
    name: "Vivid",
    src: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=150&h=150&fit=crop&sat=50",
  },
  {
    name: "B&W",
    src: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=150&h=150&fit=crop&sat=-100",
  },
  {
    name: "Warm",
    src: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=150&h=150&fit=crop&temp=20",
  },
  {
    name: "Cool",
    src: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=150&h=150&fit=crop&temp=-20",
...
export function PhotoEditor() {
  return (
    <Card
      className="h-full bg-gray-2 text-gray-12 border-gray-6 flex flex-col overflow-hidden"
      data-block="photo-editor"
    >
      ...
      <div className="p-1.5 bg-gray-2 border-t border-gray-6 space-y-1.5">
        <div className="flex items-center justify-between px-0.5">
          ...
          <Wand2 className="icon text-accent-9" />
        </div>
