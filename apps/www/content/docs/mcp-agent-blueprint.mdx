...
**Aura monorepo:** if scenario is `aura-monorepo`, link root [`AGENTS.md`](https://github.com/somosgented/aura-design-system/blob/canary/AGENTS.md) (and `.cursor/skills/aura-constraints/`, `.cursor/skills/aura-verification/`) — do **not** duplicate a full pstack vendor into the registry.
...
- [pstack](/docs/pstack) — what `/poteto-mode` is, why Aura uses it, easy install
