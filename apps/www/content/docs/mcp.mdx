...
5. Optional agent rigor: marketplace **pstack** via `/add-plugin pstack` then `/setup-pstack` (see [Agent blueprint](/docs/mcp-agent-blueprint) § E). Does not replace Aura rules/lint.
