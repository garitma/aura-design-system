...
That writes `.cursor/skills/port-component-to-aura/SKILL.md`. `aura init` / `aura setup` also install `@aura/skills` next to `@aura/rules`.

Authoring in this monorepo: edit `.cursor/skills/port-component-to-aura/SKILL.md`, then from `packages/registry`:
...
3. Install the skill: `pnpm dlx shadcn@latest add @aura/skill-port-component-to-aura` (or `@aura/skills`).
4. Paste a component URL and ask Cursor to recreate it in Aura.
