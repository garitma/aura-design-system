...
Interaction with the registry is handled through our Command Line Interface (CLI). This tool is responsible for initializing your project and fetching component code. See [CLI](/docs/cli) for the full command reference.
