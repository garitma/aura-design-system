...
<ComponentPreview name="visually-hidden-input-demo" description="A visually hidden input that mirrors a control for form submission.">
...
export function VisuallyHiddenInputDemo() {
...
```bash
pnpm dlx shadcn@latest add @aura/visually-hidden-input
```
...
<Steps>
  <Step>
    Copy and paste the VisuallyHiddenInput component into your `components/ui/VisuallyHiddenInput.tsx` file.
