...
| Prop | Type | Default |
|------|------|---------|
| *All props from* | `React.ComponentProps<typeof HoverCardRadix.Root>` | - |
...
| Prop | Type | Default |
|------|------|---------|
| *All props from* | `React.ComponentProps<typeof HoverCardRadix.Trigger>` | - |
...
| Prop | Type | Default |
|------|------|---------|
| *All props from* | `React.ComponentProps<typeof HoverCardRadix.Content>` | - |
