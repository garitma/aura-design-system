...
<ComponentPreview name="stepper-demo" description="A sequential progress indicator with navigation controls.">
...
<Steps>
  <Step>
    ...
    ```package-install
@radix-ui/react-direction @radix-ui/react-icons @radix-ui/react-slot
    ```
  </Step>
  <Step>
