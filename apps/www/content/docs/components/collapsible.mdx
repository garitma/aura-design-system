...
| Prop | Type | Default |
|------|------|---------|
| *All props from* | `React.ComponentProps<typeof CollapsibleRadix.Root>` | - |
...
| Prop | Type | Default |
|------|------|---------|
| *All props from* | `React.ComponentProps<typeof CollapsibleRadix.CollapsibleTrigger>` | - |
...
| Prop | Type | Default |
|------|------|---------|
| *All props from* | `React.ComponentProps<typeof CollapsibleRadix.CollapsibleContent>` | - |
