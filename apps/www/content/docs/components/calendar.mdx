...
<ComponentPreview name="calendar-demo" description="Displays a calendar.">
...
```bash
pnpm dlx shadcn@latest add @aura/calendar
```
...
<Steps>
  <Step>
    ...
    ```bash
pnpm install @radix-ui/react-icons react-day-picker
    ```
  </Step>
  <Step>
...
```
  ...
  <Step>
    Copy and paste the Calendar component into your `components/ui/Calendar.tsx` file.
