  ...
  return (
    <AccordionRadix.Header className="flex">
      <AccordionRadix.Trigger
        ...
        className={cn(
          "group flex justify-between flex-1 cursor-pointer items-center gap-1 p-1 w-full h6 border border-b-1 border-gray-6 border-x-0 border-t-0 px-2 font-normal",
          className
        )}
        {...props}
      >
