...
The CSS custom property --aura-snow can be used in a .snow class in HTML to set the background color of an element. In the CSS file, the .snow class can be defined as follows:
